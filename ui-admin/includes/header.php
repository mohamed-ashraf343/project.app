        ...
        ?>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview news">
                <a href="#"><i class="fa fa-question-circle"></i> <span> الكورسات  </span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="news-panel.php"><i class="fa fa-circle-o"></i>ادارة الكورسات </a></li>
                    <li><a href="add_news.php"><i class="fa fa-circle-o"></i>اضافةكورس جديد</a></li>
                </ul>
            </li>
